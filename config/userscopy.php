...
$config = [
    ...
    'Users.reCaptcha.key' => '6LcZ76EdAAAAAEryzPBUk7Shf385jAKpTHUdTOiw',
    'Users.reCaptcha.secret' => '6LcZ76EdAAAAAIsVl6VzwJBeLM-0IpDNiFUqI2n3',
    ...
    // 'OAuth.providers.facebook.options.clientId' => 'gpuser',
    // 'OAuth.providers.facebook.options.clientSecret' => '6LcZ76EdAAAAAIsVl6VzwJBeLM-0IpDNiFUqI2n3',
    'OAuth.providers.google.options.clientId' => 'gpuser',
    'OAuth.providers.google.options.clientSecret' => '6LcZ76EdAAAAAIsVl6VzwJBeLM-0IpDNiFUqI2n3',
    // 'OAuth.providers.twitter.options.clientId' => 'YOUR APP ID',
    // 'OAuth.providers.twitter.options.clientSecret' => '6LcZ76EdAAAAAIsVl6VzwJBeLM-0IpDNiFUqI2n3',
        ...
        'providers' => [
            'facebook' => [
                ...
                'options' => [
                    ...
                    'linkSocialUri' => Router::fullBaseUrl() . 'http://loc.cake.example.com/facebook',
                    'callbackLinkSocialUri' => Router::fullBaseUrl() . 'http://loc.cake.example.com/auth/facebook',
                ]
            ],
            'twitter' => [
            ...
            'google' => [
                ...
                'options' => [
                    ...
                    'linkSocialUri' => Router::fullBaseUrl() . 'http://loc.cake.example.com/',
                    'callbackLinkSocialUri' => Router::fullBaseUrl() . 'http://loc.cake.example.com/auth/google',
                ]
            ],
            'amazon' => [
                'service' => 'CakeDC\Auth\Social\Service\OAuth2Service',
